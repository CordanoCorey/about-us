...
const teamMembers: TeamMember[] = [
  Object.assign(new TeamMember(), {
    ...
    funFacts: [
      "Holly has visited 42 states with a life goal of visiting all 50 states."
    ]
  }),
  Object.assign(new TeamMember(), {
    name: "Dave Nichols",
    imageSrc: './assets/Dave Nichols.jpg',
    bio: [],
    funFacts: []
  }),
  Object.assign(new TeamMember(), {
    ...
    imageSrc: './assets/Aaron Clarke.jpg',
    bio: [
    ...
    funFacts: [
      "I operate a successful DJ business, MAC2 DJ Entertainment. I also enjoy showing my classic car, a Pontiac 20th Anniversary Turbo Trans Am."
    ]
  }),
  Object.assign(new TeamMember(), {
    name: "Aaron Sica",
    title: "Application Support Specialist",
    imageSrc: './assets/Aaron Sica.jpg',
    bio: [
  ...
  Object.assign(new TeamMember(), {
    name: "Adam Shank",
    title: "Application Support Specialist",
    imageSrc: './assets/Adam Shank.jpg',
    bio: [
  ...
  Object.assign(new TeamMember(), {
    name: "Andrew Rhoads",
    title: "Application Support Specialist",
    imageSrc: './assets/Andrew Rhoads.jpg',
    bio: [
  ...
  Object.assign(new TeamMember(), {
    name: "Beth Cappello",
    imageSrc: './assets/Elizabeth Cappello.jpg',
    bio: [
  ...
  Object.assign(new TeamMember(), {
    ...
    imageSrc: './assets/Bryan Guerrisi.jpg',
    bio: [
  ...
  Object.assign(new TeamMember(), {
    ...
    imageSrc: './assets/Casey Stepp.jpg',
    bio: [
    ...
    funFacts: [
      "I live on a 40 acre farm, I was proposed to with an entire field of sunflowers and I can play the piano, flute and piccolo."
    ]
  }),
  Object.assign(new TeamMember(), {
    name: "Keisha Cree",
    title: "Program Assistant",
    imageSrc: './assets/Keisha Cree.jpg',
    bio: [
    ...
    funFacts: [
      "Keisha owns and runs a photography business outside of her work at CAOLA!"
    ]
  }),
  Object.assign(new TeamMember(), {
    name: "Kristen Gross",
    title: "Online Learning Support Administrator",
    imageSrc: './assets/Kristen Gross.jpg',
    bio: [
    ...
    funFacts: [
      "I currently raise 5 backyard chickens. Their names are Sara, Duck, Rose, Snowy and Pancakes."
    ]
  }),
  Object.assign(new TeamMember(), {
    name: "Matthew Brightbill",
    title: "Application Support Specialist",
    imageSrc: './assets/Matt Brightbill.jpg',
    bio: [
    ...
    funFacts: [
      "Matt was a cyber-school student throughout much of his middle school and high school career.  He also did many courses online in college as well."
    ]
  }),
  Object.assign(new TeamMember(), {
    name: "Tammy True",
    title: "Program Assistant",
    imageSrc: './assets/Tammy True.jpg',
    bio: [
    ...
    funFacts: [
      "Tammy’s favorite location is the beach. “Life’s just right with the beach in sight.”"
    ]
  })
];
