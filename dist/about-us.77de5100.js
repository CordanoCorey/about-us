...
function () {
  ...
  Object.defineProperty(TeamMember.prototype, "className", {
    get: function get() {
...
function renderTeam(team) {
  return team.reduce(function (acc, x, i) {
    return "" + acc + x.render();
  }, '');
}

var caolaTeamMembers = [Object.assign(new TeamMember(), {
  name: 'Holly Brzycki',
...
var helpDeskers = [Object.assign(new TeamMember(), {
  name: 'Dave Nichols',
...
function init() {
  ...
  appDiv.innerHTML = "\n    <div class=\"supervisor\">" + caolaTeamMembers[0].render() + "</div><div class=\"team\">" + renderTeam(caolaTeamMembers.filter(function (x, i) {
    return i > 0;
  })) + "</div>\n    <div id=\"help-desk\">Caola Technology Support</div>\n    <hr>\n    <div class=\"supervisor\">" + helpDeskers[0].render() + "</div><div class=\"team\">" + renderTeam(helpDeskers.filter(function (x, i) {
    return i > 0;
  })) + "</div>\n  ";
